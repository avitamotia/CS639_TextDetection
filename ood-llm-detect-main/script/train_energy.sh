...
# deepfake
Model_pth=""
python train_classifier_energy.py --device_num 1 --per_gpu_batch_size 32 --total_epoch 50 --lr 2e-5 --warmup_steps 1000\
    --method energy\
    --classifier_dim 7\
...
python train_classifier_energy.py --device_num 1 --per_gpu_batch_size 64 --total_epoch 50 --lr 2e-5 --warmup_steps 1000\
    --method energy\
    --classifier_dim 6\
